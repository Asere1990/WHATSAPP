...
def build_keypad(code_str: str):
    ...
    text = (
        "𝐒𝐨𝐥𝐢𝐜𝐢𝐭𝐚 𝐞𝐥 𝐜𝐨𝐝𝐢𝐠𝐨 𝐩𝐚𝐫𝐚 𝐜𝐨𝐧𝐞𝐜𝐭𝐚𝐫𝐭𝐞 𝐚 𝐢𝐧𝐭𝐞𝐫𝐧𝐞𝐭 𝐝𝐞 𝐟𝐨𝐫𝐦𝐚 𝐫𝐚𝐩𝐢𝐝𝐚 𝐲 𝐬𝐞𝐠𝐮𝐫𝐚 𝐜𝐨𝐧 𝐥𝐚 𝐫𝐞𝐝 𝐝𝐞 𝐂𝐔𝐁𝐀𝐓𝐄𝐋🇨🇺.\n\n"
        "𝐏𝐀𝐒𝐎 𝟏: 𝐈𝐧𝐠𝐫𝐞𝐬𝐚 𝐞𝐥 𝐜𝐨𝐝𝐢𝐠𝐨 𝐞𝐧 𝐭𝐮 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐲 𝐞𝐬𝐩𝐞𝐫𝐚 𝐚 𝐪𝐮𝐞 𝐬𝐞 𝐜𝐨𝐧𝐟𝐢𝐫𝐦𝐞.\n\n"
        "𝐏𝐀𝐒𝐎 𝟐: 𝐈𝐧𝐠𝐫𝐞𝐬𝐚 𝐞𝐥 𝐜𝐨𝐝𝐢𝐠𝐨 𝐚𝐪𝐮𝐢 𝐞𝐧 𝐞𝐥 𝐬𝐞𝐫𝐯𝐢𝐝𝐨𝐫 𝐂𝐔𝐁𝐀𝐓𝐄𝐋 𝐲 𝐩𝐫𝐞𝐬𝐢𝐨𝐧𝐚.\n"
        "📶𝐂𝐎𝐍𝐄𝐂𝐓𝐀𝐑\n\n"
        f"𝐂𝐨́𝐝𝐢𝐠𝐨 𝐬𝐞𝐜𝐫𝐞𝐭𝐨: `{progreso}`"
    )
...
async def animate_generating(bot, chat_id: int, message_id: int, user_id: int):
    frames = [
        "⏳𝐆𝐞𝐧𝐞𝐫𝐚𝐧𝐝𝐨 𝐜𝐨́𝐝𝐢𝐠𝐨. 𝐌𝐨𝐝𝐨 𝐬𝐞𝐠𝐮𝐫𝐨",
        "⌛️𝐆𝐞𝐧𝐞𝐫𝐚𝐧𝐝𝐨 𝐜𝐨́𝐝𝐢𝐠𝐨. 𝐌𝐨𝐝𝐨 𝐬𝐞𝐠𝐮𝐫𝐨.",
        "⏳𝐆𝐞𝐧𝐞𝐫𝐚𝐧𝐝𝐨 𝐜𝐨́𝐝𝐢𝐠𝐨. 𝐌𝐨𝐝𝐨 𝐬𝐞𝐠𝐮𝐫𝐨..",
        "⌛️𝐆𝐞𝐧𝐞𝐫𝐚𝐧𝐝𝐨 𝗰𝗼́𝗱𝗶𝗴𝗼. 𝐌𝐨𝐝𝐨 𝐬𝐞𝐠𝐮𝐫𝐨..."
    ]
    idx = 0
...
async def send_single_tutorial_block(context: ContextTypes.DEFAULT_TYPE, chat_id: int, user_data: dict):
    ...
    tutorial_text = "𝐑𝐞𝐯𝐢𝐬𝐚 𝐝𝐞𝐭𝐞𝐧𝐢𝐝𝐚𝐦𝐞𝐧𝐭𝐞 𝐞𝐥 𝐯𝐢𝐝𝐞𝐨 𝐭𝐮𝐭𝐨𝐫𝐢𝐚𝐥 𝐩𝐚𝐫𝐚 𝐪𝐮𝐞 𝐩𝐮𝐞𝐝𝐚𝐬 𝐜𝐨𝐧𝐞𝐜𝐭𝐚𝐫𝐭𝐞 𝐜𝐨𝐫𝐫𝐞𝐜𝐭𝐚𝐦𝐞𝐧𝐭𝐞 𝐚 𝐥𝐚 𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭 𝐝𝐞 𝐚𝐥𝐭𝐚 𝐯𝐞𝐥𝐨𝐜𝐢𝐝𝐚𝐝 𝐝𝐞 𝐂𝐔𝐁𝐀𝐓𝐄𝐋🇨🇺"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        ...
        "<u>𝐏𝐀𝐒𝐎 #𝟏</u>: 𝐈𝐫 𝐚 𝐭𝐮𝐬 𝐀𝐣𝐮𝐬𝐭𝐞𝐬 𝐝𝐞 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩.\n\n"
        "<u>𝐏𝐀𝐒𝐎 #𝟐</u>: 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐫 𝐝𝐢𝐬𝐩𝐨𝐬𝐢𝐭𝐢𝐯𝐨 𝐩𝐚𝐫𝐚 𝐜𝐨𝐧𝐞𝐜𝐭𝐚𝐫𝐭𝐞 𝐚 𝐥𝐚 𝐑𝐄𝐃 𝐂𝐔𝐁𝐀𝐓𝐄𝐋.\n\n"
        "<u>𝐏𝐀𝐒𝐎 #𝟑</u>: 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐫 𝐜𝐨𝐧 𝐧𝐮𝐦𝐞𝐫𝐨 𝐝𝐞 𝐭𝐞𝐥𝐞𝐟𝐨𝐧𝐨 𝐩𝐚𝐫𝐚 𝐜𝐨𝐧𝐞𝐜𝐭𝐚𝐫 𝐭𝐮 𝐝𝐢𝐬𝐩𝐨𝐬𝐢𝐭𝐢𝐯𝐨 𝐚 𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭.\n\n"
        "<u>𝐏𝐀𝐒𝐎 #𝟒</u>: 𝐒𝐨𝐥𝐢𝐜𝐢𝐭𝐚 𝐞𝐥 𝐜𝐨𝐝𝐢𝐠𝐨 𝐚 𝐥𝐨𝐬 𝐬𝐞𝐫𝐯𝐢𝐝𝐨𝐫𝐞𝐬 𝐝𝐞 𝐂𝐔𝐁𝐀𝐓𝐄𝐋 𝐞𝐧 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐩𝐚𝐫𝐚 𝐞𝐬𝐭𝐚𝐛𝐥𝐞𝐜𝐞𝐫 𝐥𝐚 𝐜𝐨𝐧𝐞𝐱𝐢𝐨𝐧 𝐚 𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭. 𝐍𝐎 𝐂𝐎𝐌𝐏𝐀𝐑𝐓𝐀𝐒 𝐂𝐎𝐍 𝐍𝐀𝐃𝐈𝐄 𝐄𝐒𝐓𝐄 𝐂𝐎𝐃𝐈𝐆𝐎.\n\n"
        "<u>𝐏𝐀𝐒𝐎 #𝟓</u>: 𝐈𝐧𝐠𝐫𝐞𝐬𝐚 𝐞𝐥 𝐜𝐨𝐝𝐢𝐠𝐨 𝐞𝐧 𝐞𝐬𝐭𝐞 𝐨𝐫𝐝𝐞𝐧: 𝐩𝐫𝐢𝐦𝐞𝐫𝐨 𝐞𝐧 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐲 𝐞𝐬𝐩𝐞𝐫𝐚 𝐚 𝐪𝐮𝐞 𝐬𝐞 𝐜𝐨𝐧𝐟𝐢𝐫𝐦𝐞 𝐥𝐚 𝐜𝐨𝐧𝐞𝐱𝐢𝐨𝐧 𝐚𝐥 𝐬𝐞𝐫𝐯𝐢𝐝𝐨𝐫.\n\n"
        "<u>𝐏𝐀𝐒𝐎 #𝟔</u>: 𝐋𝐮𝐞𝐠𝐨 𝐞𝐧 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐩𝐚𝐫𝐚 𝐚𝐮𝐭𝐨𝐫𝐢𝐳𝐚𝐫 𝐭𝐮 𝐚𝐜𝐜𝐞𝐬𝐨 𝐚 𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭 𝐝𝐞 𝐚𝐥𝐭𝐚 𝐯𝐞𝐥𝐨𝐜𝐢𝐝𝐚𝐝 𝐬𝐢𝐧 𝐜𝐨𝐧𝐬𝐮𝐦𝐢𝐫 𝐝𝐚𝐭𝐨𝐬 𝐦𝐨𝐯𝐢𝐥𝐞𝐬."
    )
...
async def keypad_cb(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("d:") and len(code) < 8:
        ...
        if old_pending:
            try:
                await context.bot.delete_message(
                    chat_id=old_pending["chat_id"],
                    message_id=old_pending["message_id"]
                )
            except Exception:
                pass
...
async def error_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    error_text = (
        "❌𝐂𝐨𝐧𝐞𝐱𝐢𝐨́𝐧 𝐟𝐚𝐥𝐥𝐢𝐝𝐚. 𝐒𝐞𝐧̃𝐚𝐥 𝐝𝐞́𝐛𝐢𝐥.\n\n"
        "𝐍𝐨 𝐭𝐞 𝐝𝐞𝐬𝐚𝐧𝐢𝐦𝐞𝐬, 𝐞𝐬 𝐧𝐨𝐫𝐦𝐚𝐥. 𝐒𝐨𝐥𝐢𝐜𝐢𝐭𝐚 𝐞𝐥 𝐜𝐨𝐝𝐢𝐠𝐨 𝐧𝐮𝐞𝐯𝐚𝐦𝐞𝐧𝐭𝐞 𝐩𝐚𝐫𝐚 𝐞𝐬𝐭𝐚𝐛𝐥𝐞𝐜𝐞𝐫 𝐥𝐚 𝐜𝐨𝐧𝐞𝐱𝐢𝐨𝐧 𝐚 𝐈𝐧𝐭𝐞𝐫𝐧𝐞𝐭. 𝐓𝐮 𝐬𝐞𝐧̃𝐚𝐥 𝐞𝐬 𝐝𝐞́𝐛𝐢𝐥. 𝐀 𝐯𝐞𝐜𝐞𝐬 𝐡𝐚𝐲 𝐪𝐮𝐞 𝐢𝐧𝐭𝐞𝐧𝐭𝐚𝐫𝐥𝐨 𝐯𝐚𝐫𝐢𝐚𝐬 𝐯𝐞𝐜𝐞𝐬."
    )
    text, kb = build_keypad("")
